...
VulkanContext::VulkanContext()
    : m_instance(VK_NULL_HANDLE), m_device(VK_NULL_HANDLE),
      m_physicalDevice(VK_NULL_HANDLE), m_surface(VK_NULL_HANDLE),
      m_swapchain(VK_NULL_HANDLE), m_graphicsQueue(VK_NULL_HANDLE),
      m_presentQueue(VK_NULL_HANDLE), m_graphicsQueueFamily(0) {}

VulkanContext::~VulkanContext() { Cleanup(); }

bool VulkanContext::Initialize(GLFWwindow *window, uint32_t width,
                               uint32_t height) {
