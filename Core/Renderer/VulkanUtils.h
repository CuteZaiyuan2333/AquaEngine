...
public:
    ...
    // 错误检查工具
    static void CheckVkResult(VkResult result, const std::string& operation) {
        if (result != VK_SUCCESS) {
            throw std::runtime_error("Vulkan operation failed: " + operation + " (Error: " + std::to_string(result) + ")");
        }
    }
};
